window.STORY = {
  ...
  nodes: {
    ...
    silence_1: {
      ...
      speaker: "Luna",
      mood: "sad",
      text: "Sonra bir an gelir. Çok kısa, çok hızlı, ama Luna’nın içinde uzun süren bir an.\n\nSevgilisi, Luna’nın hazır olmadığı bir anda aralarındaki güven çizgisini aşacak kadar aceleci davranır. Hemen durur. Hemen pişman olur. Ama Luna’nın içinde bir şey değişmiştir.\n\nEskiden mesaj geldiğinde yüzü yumuşardı. Şimdi önce duraksar; kalbi, eski sıcaklığı hatırlasa da kendini korumak ister.",
      choices: [
    ...
    apology_1: {
      ...
      speaker: "Sevgili",
      mood: "sad",
      text: "Mesaj gelir. Bu kez uzun ama kendini savunan bir mesaj değildir.\n\n'Seni sevdiğimi söyleyerek yaptığım hatayı hafifletemem. Senin hazır olmadığın bir anda çizgini aştım. O anda durmam gerekiyordu. Pişmanım ama senden hemen iyi olmanı beklemiyorum.'\n\nLuna mesajı birkaç kez okur. İçindeki kırgınlık geçmez; ama ilk kez karşısında inkâr değil, sorumluluk görür.",
      choices: [
